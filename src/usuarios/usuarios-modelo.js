...
/**
 * A classe Usuario é responsável por gerenciar todas as operações
 * relacionadas a usuário
 */
class Usuario {
  /**
   * O construtor recebe os dados de um usuário e os atribui a 
   * instância atual
  ...
  /**
   * @throws {InvalidArgumentError} ocorre quando um e-mail já cadastrado 
   * tenta ser cadastrado novamente
   */
  async adiciona () {
